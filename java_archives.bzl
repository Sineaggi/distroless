...
def repositories():
    ...
    # todo: platforms has os and cpu, how can we add openjdk vendor (i.e. corretto) as an additional filter?
    # todo: split archive download and extract into separate rules
    ...
    remote_java_repository(
        ...
        urls = [
            "https://corretto.aws/downloads/resources/11.0.20.9.1/amazon-corretto-11.0.20.9.1-macosx-x64.tar.gz",
        ],
        version = "11",
    )
    ...
    remote_java_repository(
        ...
        urls = [
            "https://corretto.aws/downloads/resources/17.0.8.8.1/amazon-corretto-17.0.8.8.1-macosx-x64.tar.gz",
        ],
        version = "17",
    )
    ...
    remote_java_repository(
        ...
        urls = [
            "https://corretto.aws/downloads/resources/20.0.2.10.1/amazon-corretto-20.0.2.10.1-macosx-x64.tar.gz",
        ],
        version = "20",
    )
    ...
    remote_java_repository(
        ...
        urls = [
            "https://corretto.aws/downloads/resources/21.0.0.35.1/amazon-corretto-21.0.0.35.1-macosx-x64.tar.gz",
        ],
        version = "21",
    )
    ...
    java_archive(
        ...
        jlink_jdk = "@corretto_jdk11_macos_amd64//:WORKSPACE",
    )
    ...
    java_archive(
        ...
        architecture = "amd64",
        control = "//java:control",
        jlink_jdk = "@corretto_jdk17_macos_amd64//:WORKSPACE",
    )
    ...
    java_archive(
        ...
        architecture = "amd64",
        control = "//java:control",
        jlink_jdk = "@corretto_jdk20_macos_amd64//:WORKSPACE",
    )
    ...
    java_archive(
        ...
        architecture = "amd64",
        control = "//java:control",
        jlink_jdk = "@corretto_jdk21_macos_amd64//:WORKSPACE",
    )
